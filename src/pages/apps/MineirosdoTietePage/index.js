      ...
      <div className="wrapperContainer">
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={AfranioApkAndroid}
              download="AfranioTavares.apk"
              id="AndroidButton"
            >
        ...
        <div className="cardPerson">
          ...
          <h3>Ana Olaia</h3>
          <div className="alignButtons">
            <a href={AnaoLaiaAndroid} download="Ana.apk" id="AndroidButton">
              Download App Android
            </a>
            <a id="IosButton">Download App ios</a>
          </div>
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={betoramosAndroid}
              download="BetoRamos.apk"
              id="AndroidButton"
            >
              Download App Android
            </a>
        ...
        <div className="cardPerson">
          ...
          <h3>Bocão</h3>
          <div className="alignButtons">
            <a href={bocao55678Android} download="Bocão.apk" id="AndroidButton">
              Download App Android
            </a>
            <a id="IosButton">Download App ios</a>
          </div>
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={edimilsoneufrasio55125Android}
              download="EdimilsonEufrasio.apk"
              id="AndroidButton"
            >
              Download App Android
            </a>
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={enadillavoltolin55888Android}
              download="Enadillavoltolin.apk"
              id="AndroidButton"
            >
              Download App Android
            </a>
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={gabrielabig55333Android}
              download="GabrielaBig.apk"
              id="AndroidButton"
            >
              Download App Android
            </a>
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={marcopadaria55444Android}
              download="MarcoPadaria.apk"
              id="AndroidButton"
            >
              Download App Android
            </a>
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={marildapaulucci55222Android}
              download="MarildaPaulucci.apk"
              id="AndroidButton"
            >
              Download App Android
            </a>
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={maurorodrigues55111Android}
              download="MauroRodrigues.apk"
              id="AndroidButton"
            >
              Download App Android
            </a>
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={thallesrodrigues20000Android}
              download="ThalesRodrigues.apk"
              id="AndroidButton"
            >
              Download App Android
            </a>
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={vaniabraga13222Android}
              download="VaniaBraga.apk"
              id="AndroidButton"
            >
              Download App Android
            </a>
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={vadi123465Android}
              download="VadiCezarin.apk"
              id="AndroidButton"
            >
              Download App Android
            </a>
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={tiochico55456Android}
              download="TioChico.apk"
              id="AndroidButton"
            >
              Download App Android
            </a>
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={sidineygasparotto13000Android}
              download="SidneyGasparotto.apk"
              id="AndroidButton"
            >
              Download App Android
            </a>
        ...
        <div className="cardPerson">
          ...
          <h3>Fefe</h3>
          <div className="alignButtons">
            <a href={fefe55123Android} download="Fefe.apk" id="AndroidButton">
              Download App Android
            </a>
            <a id="IosButton">Download App ios</a>
          </div>
        ...
        <div className="cardPerson">
          ...
          <div className="alignButtons">
            <a
              href={elainedasaude20200Android}
              download="ElaineDaSaude.apk"
              id="AndroidButton"
            >
              Download App Android
            </a>
